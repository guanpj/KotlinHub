...
final class GithubListObservable<GitHubPagingBody> extends Observable<GitHubPagingBody> {
    private final Observable<Response<GitHubPagingBody>> upstream;

    GithubListObservable(Observable<Response<GitHubPagingBody>> upstream) {
        this.upstream = upstream;
    }

    @Override
    protected void subscribeActual(Observer<? super GitHubPagingBody> observer) {
        upstream.subscribe(new BodyObserver<GitHubPagingBody>(observer));
    }

    private static class BodyObserver<GitHubPagingBody> implements Observer<Response<GitHubPagingBody>> {
        private final Observer<? super GitHubPagingBody> observer;
        private boolean terminated;

        BodyObserver(Observer<? super GitHubPagingBody> observer) {
